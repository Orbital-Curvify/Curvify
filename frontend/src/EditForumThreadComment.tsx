...
const EditForumThreadComment = () => {
  ...
  const [forumThreadComment, setForumThreadComment] = useState<ForumThreadCommentStorage>()
      ...
      <div className="row">
        <div className="col-sm-12 col-lg-6 offset-lg-3">
          ...
          <form onSubmit={onSubmit}>
            ...
            <Link to={`/forumThread/${forumThreadComment.forum_thread_id}`} className="btn custom-button mt-3">
              Back to Thread
            </Link>
          </form>
        </div>
